...
#define TOKENS_RE         ";|:=|->|\\+|-|_|Mul|,|Eg|Ne|:|\\[|\\]|\\(|\\)|\\{|\\}|>>|<<|[_0-9A-Za-z]+|[^ \t\r\f\v\n]"
#define KEYWORDS_RE       ";|:=|->|\\+|-|_|Mul|,|Eg|Ne|:|\\[|\\]|\\(|\\)|\\{|\\}|Program|Var|Begin|End|BREAK|CONTINUE|Get|Put|If|Else|For|To|DOWNTO|Do|WHILE|REPEAT|UNTIL|GOTO|Div|Mod|>>|<<|!|And|Or|Int16"
...
#define DEFAULT_INPUT_FILE "file1.v03"
